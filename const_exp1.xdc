...
set_property -dict { PACKAGE_PIN U12    IOSTANDARD LVCMOS33 } [get_ports { b[5] }]; #IO_L24P_T3_35 Sch=sw[12]                        
set_property -dict { PACKAGE_PIN U11    IOSTANDARD LVCMOS33 } [get_ports { b[6] }]; #IO_L24P_T3_35 Sch=sw[12]
