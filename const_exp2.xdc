...
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { num[0] }]; #IO_L24N_T3_RS0_15 Sch=sw[0]                      
set_property -dict { PACKAGE_PIN U11   IOSTANDARD LVCMOS33 } [get_ports { num[1] }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]                
set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { num[2] }]; #IO_L6N_T0_D08_VREF_14 Sch=sw[2]                  
set_property -dict { PACKAGE_PIN H6   IOSTANDARD LVCMOS33 } [get_ports { num[3] }]; #IO_L13N_T2_MRCC_14 Sch=sw[3]                     
set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports { num[4] }]; #IO_L12N_T1_MRCC_14 Sch=sw[4]                     
set_property -dict { PACKAGE_PIN R16   IOSTANDARD LVCMOS33 } [get_ports { num[5] }]; #IO_L7N_T1_D10_14 Sch=sw[5]                       
set_property -dict { PACKAGE_PIN U8   IOSTANDARD LVCMOS33 } [get_ports { num[6] }]; #IO_L17N_T2_A13_D29_14 Sch=sw[6]                  
set_property -dict { PACKAGE_PIN T8   IOSTANDARD LVCMOS33 } [get_ports { num[7] }]; #IO_L5N_T0_D07_14 Sch=sw[7]      
